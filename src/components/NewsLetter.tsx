...
export default function NewsLetter() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex h-full flex-col justify-between">
      ...
      <div className="mt-4 flex items-center justify-between border-b-2 border-b-gray-400">
      ...
      {showInfo &&
        (
          <div className={`fixed top-2 right-2 p-2 text-black ${error ? 'bg-red-500 shadow-md shadow-red-200' : 'bg-white shadow-md shadow-gray-200'} outline outline-1 outline-black opacity-0 animate-appear`}>
